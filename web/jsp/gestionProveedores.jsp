    ...
    <body>
        ...
        <main>
            <div class="agregarNuevo">
                ...
                <form action="<%= request.getContextPath() %>/GestionarProveedor"  method="post">
                    ...
                    <tbody>
                        <%
                            ...
                            try {
                                ...
                                String sql = "SELECT idProveedor, nombreProveedor, direccionProveedor, telefonoProveedor, correoProveedor, rucProveedor FROM proveedor";
